...
class MockData {
  ...
  static final List<Story> stories = [
    Story(id: 's1', userId: 'u2', userName: 'Mama Fatima', category: 'community', isViewed: false, postedAt: DateTime(2026, 6, 22, 8)),
    Story(id: 's2', userId: 'u1', userName: 'Sarah Green', category: 'community', isViewed: false, postedAt: DateTime(2026, 6, 22, 7)),
    Story(id: 's3', userId: 'u3', userName: 'BridgeBuilders', category: 'environment', isViewed: true, postedAt: DateTime(2026, 6, 21, 18)),
    Story(id: 's4', userId: 'u4', userName: 'James Mwangi', category: 'agriculture', isViewed: false, postedAt: DateTime(2026, 6, 22, 6)),
    Story(id: 's5', userId: 'u5', userName: 'Elena R.', category: 'community', isViewed: true, postedAt: DateTime(2026, 6, 21, 14)),
    Story(id: 's6', userId: 'u6', userName: 'KRF', category: 'community', isViewed: true, postedAt: DateTime(2026, 6, 21, 10)),
    Story(id: 's7', userId: 'u2', userName: 'Mama Fatima', category: 'community', isViewed: false, postedAt: DateTime(2026, 6, 22, 9)),
  ...
  static final List<Ad> ads = [
    const Ad(
      ...
      category: 'community', ctaText: 'Get Started',
    ),
    const Ad(
    ...
    const Ad(
      ...
      category: 'community', ctaText: 'Try Premium',
    ),
  ];
